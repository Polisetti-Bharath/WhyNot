...
Respond ONLY with actual valid JSON.`;
  ...
  try {
    ...
    return {
      ...
      resumeFeedback: [
        'Ensure your resume highlights quantifiable achievements.',
        'Tailor your skills section to the job description.',
      ],
      actionPlan: [
        'Complete a relevant certification.',
        'Build a portfolio project demonstrating missing skills.',
      ],
      sentiment:
        'Keep going! Many candidates face rejections before landing the right role. This explanation is based on declared profile data and listed eligibility criteria. Final hiring decisions may include additional factors.',
    };
  }
};
...
export const generateBulkRejectionAnalysis = async (data: any, userId: string = 'anonymous') => {
  return {
    ...
    improvementPriorities: [
      'Acquire domain-specific certifications',
      'Improve ATS resume formatting',
    ],
    industryInsights:
      'The market is increasingly demanding specialized tech stacks over general knowledge. This analysis is based on declared profile data and listed eligibility criteria. Final hiring decisions may include additional factors.',
  };
};
